...
function update() {
    ...
    //if enemyBullets hit tank then call bulletHitPlayer() method
 ...
 * @method fireAtAngle
 * @param angle
 * @descrption fireTowardTo an angle
 */
function fireAtAngle(angle) {
...
/**
 * @method fireAtAngle
 * @param radia radian equal angle was divided by 180
 * @descrption fireTowardTo an angle
 */
function fireAt(radian) {
